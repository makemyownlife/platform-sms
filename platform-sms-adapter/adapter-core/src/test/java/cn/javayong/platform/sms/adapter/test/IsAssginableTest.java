...
public class IsAssginableTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Class<?> clazz1 = cl1.loadClass("cn.javayong.platform.sms.adapter.test.JustAClass");
        Class<?> clazz2 = cl2.loadClass("cn.javayong.platform.sms.adapter.test.JustAClass");
