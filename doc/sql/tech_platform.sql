...
CREATE TABLE `t_sms_record` (
  ...
  `nationcode` varchar(10) NOT NULL DEFAULT '86' COMMENT '国际电话区号如 86',
  `app_id` varchar(30) DEFAULT NULL COMMENT '调用服务方',
  `record_type` tinyint(4) DEFAULT '0' COMMENT '0：验证码  1 ：通知 2 ：营销',
...
CREATE TABLE `t_sms_template` (
  ...
  `template_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0：验证码 1：短信通知 2：推广短信',
